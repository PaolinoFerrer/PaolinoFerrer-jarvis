...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 5a3 3 0 1 0-5.993.296M12 5a3 3 0 1 1 5.993.296M12 15a3 3 0 1 0-5.993.296M12 15a3 3 0 1 1 5.993.296M15 12a3 3 0 1 0-5.993.296M15 12a3 3 0 1 1 5.993.296M9 12a3 3 0 1 0-5.993.296M9 12a3 3 0 1 1 5.993.296M5 10.5V13.5M19 10.5V13.5M10.5 5H13.5M10.5 19H13.5" />
    </svg>
);
