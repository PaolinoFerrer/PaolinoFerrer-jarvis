    ...
    <div className="bg-jarvis-surface rounded-lg flex flex-col h-full overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-jarvis-text/10">
        ...
        <div className="flex items-center gap-2 bg-jarvis-bg rounded-lg p-2">
          ...
          {/* FIX: Replaced input with textarea for multi-line input, which resolves the cryptic 'area' prop error by implementing the likely intended functionality. A textarea is more appropriate for potentially long descriptions. */}
          <textarea
            rows={1}
            value={inputText}
